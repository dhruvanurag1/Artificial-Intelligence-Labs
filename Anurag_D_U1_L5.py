...
def make_graph(nodes = "/Users/dhruvanurag/Documents/TJ/AI/rrNodes.txt", node_city = "/Users/dhruvanurag/Documents/TJ/AI/rrNodeCity.txt", edges = "rrEdges.txt"):
  ...
  #       if(line_array[0] not in neighbors or line_array[1] not in neighbors):
  #          if(line_array[0] not in neighbors):
  #             neighbors[line_array[0]] = {line_array[1]}
  #             if(line_array[1] in neighbors):
  #                neighbors[line_array[1]].add(line_array[0])
  #          if(line_array[1] not in neighbors):
  #             neighbors[line_array[1]] = {line_array[0]}
  #             if(line_array[0] in neighbors):
  #                neighbors[line_array[0]].add(line_array[1])
  #       else:
  #          neighbors[line_array[1]].add(line_array[0])
  #          neighbors[line_array[0]].add(line_array[1])
  for a in neighbors:
...
def main():
  ...
  graph = make_graph("C:/Users/1822777/Downloads/rrNodes.txt", "C:/Users/1822777/Downloads/rrNodeCity.txt", "C:/Users/1822777/Downloads/rrEdges.txt")  # Task 1
  #print(graph)
  #cur_time = time.time()
