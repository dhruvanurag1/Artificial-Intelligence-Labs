...
def select_unassigned_var(assignment, csp_table):
   ...
   return random.choice([a for a in range(24) if assignment[a] == '.'])
...
def main():
   csp_table = {0: {1, 19}, 1: {0, 2, 8}, 2: {1, 3, 6}, 3: {2}, 4: {5}, 5: {4, 6, 15}, 6: {2, 7, 5}, 7 : {6}, 8: {1}, 9: {10}, 10 : {9, 11},
   11 : {10, 12, 18}, 12: {11, 13, 16}, 13: {12}, 14: {15}, 15: {5, 14, 16}, 16: {15, 12, 17}}
